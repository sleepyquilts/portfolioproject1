...
<body>
    ...
    <main>
        ...
        <div class="workexamples">
            <div id="example1">
            <a target="_blank" href="https://carlo-santos-oc.github.io/Olympic_College_Carlo_Santos_-CIS_155_Winter_2021/V4/index.html" >
              <img src="images/work attributes/carlo_covid.PNG" alt="Carlo's Covid website" width="500px">
            </a>
            <p>
                Carlo's Work CIS 155 - Winter 2021
            </p>
            </div>
            <div id="example2">
                <a target="_blank" href="https://www.fluke.com/en-us/products/condition-monitoring" >
                <img src="images/work attributes/carlo_fluke.PNG" alt="Carlo's Condition Monitoring" width="500px">
                </a>
                <p>
                    Carlo's Freelance Work
                </p>
            </div>
          </div>
